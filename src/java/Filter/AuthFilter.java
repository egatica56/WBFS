...
public class AuthFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        //obtenemos la URL a la que el usuario intenta ingresar
        String url= httpRequest.getRequestURI();
        //Obtenemos la url de la pagina del login
        String urlLogin = httpRequest.getContextPath()+ "/login";
        // si esta tratando de ingresar al login
        if (url.equals(urlLogin)){
        return;
        }
        
        //preguntamos si existe la variable usuario en la sesion
